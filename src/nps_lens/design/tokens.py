...
class DesignTokens:
    ...
    def default() -> "DesignTokens":
        ...
        light: dict[str, str] = {
            ...
            "color.app.control.placeholder": "#66728a",
            "color.app.control.icon": "#001391",
            "color.app.control.menu.bg": "#ffffff",
            "color.app.control.menu.item.hover": "#edf3ff",
            "color.app.control.menu.item.selected": "#dbeafe",
        ...
        dark: dict[str, str] = {
            ...
            "color.app.chart.paper": "#11192d",
            "color.app.chart.plot": "#16203a",
            "color.app.chart.grid": "#3a4761",
            "color.app.chart.zero-line": "#4a5975",
            "color.app.table.bg": "#11192d",
            "color.app.table.bg.alt": "#16203a",
            "color.app.table.bg.hover": "#1f2c49",
            "color.app.table.header.bg": "#1b2844",
            "color.app.table.header.text": "#c9d4ef",
            "color.app.table.border": "#334056",
            "color.app.control.bg": "#16203a",
            "color.app.control.bg.hover": "#1f2c49",
            "color.app.control.border": "#3a4761",
            "color.app.control.text": "#ffffff",
            "color.app.control.placeholder": "#c9d4ef",
            "color.app.control.icon": "#85c8ff",
            "color.app.control.menu.bg": "#16203a",
            "color.app.control.menu.item.hover": "#233455",
            "color.app.control.menu.item.selected": "#2b3f66",
            "color.primary.bg.action.default": "#001391",
            "color.primary.bg.action.active": "#070e46",
...
def executive_report_palette(tokens: DesignTokens, mode: str = "light") -> dict[str, str]:
    ...
    return {
        ...
        "amber": p["color.primary.bg.warning"].lstrip("#").upper(),
        "yellow": p["color.primary.bg.warning"].lstrip("#").upper(),
        "orange": p["color.primary.accent.value-01.pressed"].lstrip("#").upper(),
